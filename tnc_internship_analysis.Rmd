...
write.csv(aic_tab, file = "aic_table.csv", row.names = FALSE)
```
...
ggsave("eff_plot.jpeg", plot = eff_plot, width = 6, height = 4, dpi = 300)
...
ggsave("det_plot.jpeg", plot = det_plot, width = 6, height = 4, dpi = 300)
